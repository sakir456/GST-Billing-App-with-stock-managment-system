  ...
  return (
    <div className="h-screen w-auto bg-customGreen  pt-2 flex flex-col">
      ...
      <ul className="text-white">
        ...
        <li className="hover:hover:bg-customLightGreen hover:border-l-4 hover:border-white py-2 pl-4">
        ...
        <li className="hover:hover:bg-customLightGreen hover:border-l-4 hover:border-white py-2 pl-4">
          <button onClick={() => toggleItem('items')} className="w-full h-full flex items-center justify-between">
            <span>Items</span>
        ...
        <li className="flex items-center justify-between py-2 pl-4 hover:hover:bg-customLightGreen hover:border-l-4 hover:border-white cursor-pointer">
          <span>Reports</span>
        </li>
